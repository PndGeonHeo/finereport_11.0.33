...
<TableDataMap>
<TableData name="tourist attractions" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[name,,.,,lng,,.,,lat,,.,,tourist]]></ColumnNames>
<ColumnTypes>
...
<![CDATA[--\.S_CuCPiRp@_:12&$S(JsV5[p\1^`5Yj8t]A4Z@H_^@#.NP<"L5Z!e,+@\GZu6WS4`nR!B
!J)8jEE2=J>sADS9s`_d&Kbrt/s;-:#YH(57;&BDUk<)i?_YpH2g!'Ue4k1F0?'Ap)'<eF^/
7\*U[L?R@Ho2@HSn&Oe!6AI)1FZi@[Fm^UK9lge**$%;2=Ck4`M.4nOKJ\M~
]]></RowData>
</TableData>
<TableData name="east asia" class="com.fr.data.impl.EmbeddedTableData">
<Parameters/>
<DSName>
<![CDATA[]]></DSName>
<ColumnNames>
<![CDATA[name,,.,,value]]></ColumnNames>
<ColumnTypes>
<![CDATA[java.lang.String,java.lang.String]]></ColumnTypes>
<RowData ColumnTypes="java.lang.String,java.lang.String">
<![CDATA[o1dG#X=VXjj>>rgbY-((9*MS[\3_q`1NO3#;E0ZHJi!#H'+=Ah;E7I]A_D5%_ne-"(9`Y~
]]></RowData>
</TableData>
</TableDataMap>
<FormMobileAttr>
...
<TextAttr>
<Attr alignText="0">
<FRFont name=".SF NS Text" style="0" size="72" foreground="-13421671"/>
</Attr>
</TextAttr>
<AttrToolTipContent>
<Attr isCommon="true"/>
...
<VanChartMapPlotAttr mapType="custom" geourl="assets/map/geographic/world/Southeast Asia.json" zoomlevel="0" mapmarkertype="0" nullvaluecolor="-3355444"/>
<lineMapDataProcessor>
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
</lineMapDataProcessor>
<GisLayer>
<Attr gislayer="predefined_layer" layerName="Midnight"/>
</GisLayer>
<ViewCenter auto="false" longitude="104.5743433" latitude="2.136094"/>
...
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[tourist attractions]]></Name>
</TableData>
<CategoryName value="name"/>
<ChartSummaryColumn name="tourist" function="com.fr.data.util.function.NoneFunction" customName="tourist"/>
</MoreNameCDDefinition>
...
<VanChartPlotAttr isAxisRotation="false" categoryNum="1"/>
<VanChartMapPlotAttr mapType="custom" geourl="assets/map/geographic/world/SEA.json" zoomlevel="0" mapmarkertype="0" nullvaluecolor="-3355444"/>
<lineMapDataProcessor>
<DataProcessor class="com.fr.base.chart.chartdata.model.NormalDataModel"/>
</lineMapDataProcessor>
<GisLayer>
<Attr gislayer="custom" layerName="Custom tileLayer" customtilelayer="https://api.mapbox.com/styles/v1/wsj96522/ck0nh6mct76cs1cpfp5s2ew2n/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoid3NqOTY1MjIiLCJhIjoiY2p6Z2RxbzhzMGt0ajNicWZpZXNqcnVtNSJ9.GMkA7bZ92US60OXInsINcg" attribution=""/>
</GisLayer>
<ViewCenter auto="false" longitude="104.5743433" latitude="2.136094"/>
<pointConditionCollection>
<ConditionCollection>
...
<CategoryName value="name"/>
<ChartSummaryColumn name="name" function="com.fr.data.util.function.NoneFunction" customName="name"/>
</MoreNameCDDefinition>
<attr longitude="lng" latitude="lat" endLongitude="" endLatitude="" useAreaName="false" endAreaName=""/>
</pointDefinition>
<lineDefinition class="com.fr.plugin.chart.map.data.VanMapMoreNameCDDefinition">
...
<TemplateIdAttMark TemplateId="732b74cd-40fa-4b2c-a13f-be36774584b3"/>
</TemplateIdAttMark>
</Form>
