...
<Query>
<![CDATA[select distinct a.name,round(${e1},2) as field_type from 
(SELECT  Name||' '||Family_name as name,sum(Unit_price*Quantity*(1-Discount)) as Sales_Income
FROM SEmploye,SIndent,SIndentDetail
where SEmploye.EmployeeID=SIndent.EmployeeID and SIndent.OrderID=SIndentDetail.OrderID
group by Name||' '||Family_name
order by sum(Unit_price*Quantity*(1-Discount)) desc ) as a,
(SELECT  Name||' '||Family_name as name,sum(Unit_price*Quantity*(1-Discount)) as Repayment_Amount
FROM SEmploye,SIndent,SIndentDetail
where SEmploye.EmployeeID=SIndent.EmployeeID and SIndent.OrderID=SIndentDetail.OrderID and sIndent.Paid_or_not='Yes'
group by Name||' '||Family_name
order by sum(Unit_price*Quantity*(1-Discount)) desc ) as b,ReturnedMoney_Rate
where a.name=b.name and a.name=Name_of_employees]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT  strftime('%m',SIndent.Order_date) as Month,sum(Unit_price*Quantity*(1-Discount)) as Sales_Income
FROM SIndent,SIndentDetail,SEmploye
where SIndent.EmployeeID=SEmploye.EmployeeID and SIndent.OrderID=SIndentDetail.OrderID and strftime('%Y',SIndent.Order_date)='${nian}' and SEmploye.Name||' '||SEmploye.Family_name='${name}'
group by strftime('%m',SIndent.Order_date)]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT * FROM ReturnedMoney_Rate
where Name_of_employees='${name}']]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT Name_of_employees,Proportion 
FROM SaleroomScale
where Name_of_employees='${name}'
union
select 'others' , sum(Proportion) 
from SaleroomScale
where Name_of_employees<>'${name}']]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
...
<Query>
<![CDATA[SELECT * FROM EachLevelScale
where Name_of_employees='${name}']]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<WidgetTitle>
<O>
<![CDATA[=\"   Proportion of Employee\'s Orders\"]]></O>
...
<OColor>
<colvalue>
<FineColor color="-8402710" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
<FineColor color="-4856858" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
<FineColor color="-12076338" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
...
<OColor>
<colvalue>
<FineColor color="-7372364" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="Name_of_employees" valueName="Proportion" function="com.fr.data.util.function.NoneFunction">
...
<UUID uuid="3e63658f-7a69-43fa-a73a-67941426b7ca"/>
...
<BoundsAttr x="0" y="36" width="237" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Attributes>
<![CDATA[="   Proportion of Employee's Orders"]]></Attributes>
</O>
</widgetValue>
...
<BoundsAttr x="499" y="308" width="237" height="287"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.RadioGroup">
<WidgetName name="e1"/>
<WidgetAttr aspectRatioLocked="false" aspectRatioBackup="0.0" description="">
<MobileBookMark useBookMark="true" bookMarkName="e1" frozen="false" index="-1" oldWidgetName=""/>
<PrivilegeControl/>
</WidgetAttr>
<Dictionary class="com.fr.data.impl.CustomDictionary">
<CustomDictAttr>
<Dict key="Sales_Income" value="Sales Income"/>
<Dict key="Repayment_Amount" value="Repayment Amount"/>
</CustomDictAttr>
</Dictionary>
<widgetValue>
<O>
...
<BoundsAttr x="830" y="0" width="164" height="39"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<WidgetTitle>
<O>
<![CDATA[=\"   Top 10 Employee(Linkage)\"]]></O>
<FRFont name="Arial" style="0" size="104">
<foreground>
<FineColor color="-12303292" hor="-1" ver="-1"/>
</foreground>
</FRFont>
<Position pos="2"/>
<Background name="ColorBackground">
...
<OColor>
<colvalue>
<FineColor color="-12076351" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
...
<ChartSummaryColumn name="field_type" function="com.fr.data.util.function.NoneFunction" customName="field_type"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<UUID uuid="29409c00-76ec-4e1a-8cf3-c60856252d38"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy" controlType="zoom" categoryNum="8" scaling="0.3"/>
<from>
...
<BoundsAttr x="0" y="36" width="499" height="233"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="   Top 10 Employee(Linkage)"]]></Attributes>
</O>
</widgetValue>
<LabelAttr verticalcenter="true" textalign="2" autoline="true"/>
<FRFont name="Arial" style="0" size="104">
...
<BoundsAttr x="0" y="39" width="499" height="269"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<WidgetTitle>
<O>
<![CDATA[=\"   Monthly Receivable Ratio\"]]></O>
<FRFont name="Arial" style="0" size="104">
<foreground>
<FineColor color="-12303292" hor="-1" ver="-1"/>
</foreground>
...
<OColor>
<colvalue>
<FineColor color="-5346897" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
...
<ChartSummaryColumn name="Rate_of_return" function="com.fr.data.util.function.NoneFunction" customName="Rate_of_return"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<UUID uuid="264bf797-777b-4724-8875-dbd28e2a7fbb"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy" controlType="zoom" categoryNum="8" scaling="0.3"/>
<from>
...
<BoundsAttr x="0" y="36" width="499" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="   Monthly Receivable Ratio"]]></Attributes>
</O>
</widgetValue>
<LabelAttr verticalcenter="true" textalign="2" autoline="true"/>
<FRFont name="Arial" style="0" size="104">
...
<BoundsAttr x="0" y="308" width="499" height="287"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<BoundsAttr x="0" y="0" width="830" height="39"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<WidgetTitle>
<O>
<![CDATA[=\"   Total Orders Sum By Month\"]]></O>
<FRFont name="Arial" style="0" size="104">
<foreground>
<FineColor color="-12303292" hor="-1" ver="-1"/>
</foreground>
...
<Attr class="com.fr.plugin.chart.base.VanChartAttrMarker">
<VanAttrMarker>
<Attr isCommon="true" anchorSize="22.0" markerType="RoundFilledMarker" radius="4.0" width="30.0" height="30.0"/>
<Background name="NullBackground"/>
</VanAttrMarker>
</Attr>
...
<OColor>
<colvalue>
<FineColor color="-10891790" hor="-1" ver="-1"/>
</colvalue>
</OColor>
<OColor>
<colvalue>
...
<CategoryName value="Month"/>
<ChartSummaryColumn name="Sales_Income" function="com.fr.data.util.function.SumFunction" customName="Sales_Income"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<UUID uuid="1216fb00-abb6-4c94-ba0e-f39d118578f5"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy" controlType="zoom" categoryNum="8" scaling="0.3"/>
<from>
...
<BoundsAttr x="0" y="36" width="495" height="233"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="   Total Orders Sum By Month"]]></Attributes>
</O>
</widgetValue>
<LabelAttr verticalcenter="true" textalign="2" autoline="true"/>
<FRFont name="Arial" style="0" size="104">
...
<BoundsAttr x="0" y="0" width="495" height="36"/>
</Widget>
<ShowBookmarks showBookmarks="true"/>
</InnerWidget>
<BoundsAttr x="499" y="39" width="495" height="269"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<WidgetTitle>
<O>
<![CDATA[=\"   Proportion of Client Resource Quality\"]]></O>
<FRFont name="Arial" style="0" size="104">
<foreground>
<FineColor color="-12303292" hor="-1" ver="-1"/>
</foreground>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="Value_segment" valueName="Bill" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds5]]></Name>
...
<UUID uuid="5d4c0641-596f-466a-96e2-24962aa7c767"/>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
<VanChartZoom>
<zoomAttr zoomVisible="false" zoomGesture="true" zoomResize="true" zoomType="xy" controlType="zoom" categoryNum="8" scaling="0.3"/>
<from>
...
<BoundsAttr x="0" y="36" width="258" height="251"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.Label">
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="   Proportion of Client Resource Quality"]]></Attributes>
</O>
</widgetValue>
<LabelAttr verticalcenter="true" textalign="2" autoline="true"/>
<FRFont name="Arial" style="0" size="104">
...
<BoundsAttr x="736" y="308" width="258" height="287"/>
</Widget>
<ShowBookmarks showBookmarks="true"/>
<Sorted sorted="false"/>
<MobileWidgetList>
...
<TemplateIdAttMark TemplateId="73e7f0fc-1472-435d-bf03-0d9c2dc6f92c"/>
</TemplateIdAttMark>
</Form>
